...
if __name__ == "__main__":
    ...
    with beam.Pipeline(options=options) as p1:
        ...
        output_path_1 = f'gs://earthquake_data_anny/landing/{current_date}/historical-data.json'
        upload_result_1 = (
            geojson_data
    ...
    input_path_2 = f'gs://earthquake_data_anny/landing/{current_date}/historical-data.*'
    with beam.Pipeline(options=options) as p2:
        ...
        output_path_2 = f'gs://earthquake_data_anny/silver/{current_date}/historical-data.json'
        upload_result_2 = (
            processed_data
    ...
    input_path_3 = f'gs://earthquake_data_anny/silver/{current_date}/historical-data.*'
    with beam.Pipeline(options=options) as p3:
        read_result_3 = (
            ...
            | 'Write to BigQuery' >> beam.io.WriteToBigQuery(
                'bwt-lear.earthquake_dataset.earthquake_historical_data_dataflow',
